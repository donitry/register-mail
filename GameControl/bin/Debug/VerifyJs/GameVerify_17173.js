...
function getcookies(){
	...
	var sessionid = _ssid + "|" + _svn, sessionid2 = _ssid + "|" + _svn;
	...
	_jcbw[0] = "Netscape", _jcbw[7] = "zh-cn" ,_jcbw[7] = _jcbw[7].toLowerCase(), _jcbw[1] = "Chrome: 26.0.1410.66", _jcbw[2] = 1;
	_jcbw[3] = "11.7", _jcbw[4] = "Win 7", _jcbw[8] = 1, _jcbw[10] = "17173", _jcbw[11] = 1;
	_jcbw[5] = "1366x768", _jcbw[6] = "32-bit", _jcbw[9] = 0;
...
//logs.17173.com/ping.gif?1398694585303372?t?=1398694585303372?t?=1?t?=passport.17173.com?t?=http://passport.17173.com/register?t?=passport.17173.com?t?=0?t?=0?t?=Chrome:34.0.1847.131?t?=1?t?=13.0?t?=Win%207?t?=1366x768?t?=24-bit?t?=zh-cn?t?=1?t?=0?t?=ch?t?=0?t?=
	...
	_jc_purl_pvapp = "http://log1.17173.com/pv?appkey=" + _jc_appkey + "&suv=" + _jc_uv + "&ssid=" + _ssid + "&bp=" + encodeURIComponent(tmpb) + "&se=&kw=&rf=0&bwt=" + _jcbw[1] + "&bw=" + _jcbw[10] + "&Jav=" + _jcbw[2] + "&Flu=" + _jcbw[3] + "&scr=" + _jcbw[5] + "&Clr=" + _jcbw[6] + "&Os=" + _jcbw[4] + "&ck=" + _jcbw[8] + "&Ln=" + _jcbw[7] + "&rft=1";
...
function getlotcode()  //切换验证码控件
{
	return "do=code&" + Math.random()
}

function get_pgv_pvi(h){
	function q(h, c, a, b) {
		c = c + "=" + a + ";path=/;domain=";
		a = h;
		var d = {
	...
	var pvi = r(),si = r("s");
	pvi = q(h, "pgv_pvi", pvi, "Sun, 18 Jan 2038 00:00:00 GMT;"),si = q(h, "pgv_si", si);
	
	var cookies = new Array;
	cookies[0] = pvi,cookies[1] = si;
	return cookies.join("$")
}
